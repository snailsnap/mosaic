...
std::vector<Mollusc> Painter::paint(const std::vector<MolluscPosition> molluscPositions, std::shared_ptr<MolluscPalette> palette, QImage & colorImage, QImage & idImage)
{
